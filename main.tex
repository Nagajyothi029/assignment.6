...
\begin{lstlisting}p
https://github.com/nagajyothi/ASSIGNMENT6/Assignment6.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/nagajyothi/ASSIGNMENT 6/main.tex
\end{lstlisting}
%
\section{QUESTION No-2.71(g) (Quadratic forms)}
 ...
 \\
$\vec{x}^{\top}\myvec{36 & 0 \\ 0 & 4}\vec{x} = 144$.
%
\section{Solution}
...
\begin{align}
  \vec{x}^{\top}\myvec{36 & 0 \\ 0 & 4}\vec{x} = 144
  \\
  \implies \vec{x}^{\top}\myvec{\frac{1}{4} & 0 \\ 0 & \frac{1}{36}} = 1
\end{align}
we have,
\begin{align}
    \vec{V} = \myvec{\frac{1}{4} & 0 \\ 0 & \frac{1}{36}}
    \\
    \vec{u}^{\top}\vec{V}^{-1}\vec{u}-f = 1
    \\
    \vec{c} = -\vec{V}^{-1}\vec{u}=\myvec{0 \\ 0}
    \\
    \lambda_1 = \frac{1}{4} , \lambda_2 = \frac{1}{36}
\end{align}
...
\\
 ...
 \begin{align}
    b = 35
\end{align}
 Length of the minor axis is $b = {\sqrt35}$
...
\begin{align}
    l = \frac{2\brak{{\sqrt{\frac{f-\vec{u}^{\top}\vec{V}^{-1}\vec{u}}{\lambda_2}}}}}{\sqrt{\frac{\vec{u}^{\top}\vec{V}^{-1}\vec{u}-f}{\lambda_1}}} \label{eq:5}
\end{align}
