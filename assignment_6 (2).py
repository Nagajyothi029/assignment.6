...
Original file is located at
    https://colab.research.google.com/drive/13EqhTSc9ZOWBVEX5jS8LUdQc2xcZetl2
"""
...
Original file is located at
    https://colab.research.google.com/drive/1cyB9GYxqZmROzJcIj3oPS_7b02iTKKYS
"""
...
Original file is located at
    https://colab.research.google.com/drive/14L4rxAr9weYp26ootkumOpI7sg9OKs5q
"""
...
F_1=np.array([c,0])
OF_1 = line_gen(O,F_1)
plt.plot(OF_1[0,:],OF_1[1,:],'g',label='Foci')
 
#Plotting line OF_2
O=np.array([0,0])
F_2=np.array([-c,0])
OF_2 = line_gen(O,F_2)
plt.plot(OF_2[0,:],OF_2[1,:],'g',label='Foci')
